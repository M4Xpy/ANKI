    ...
    while True:
        ...
        if prev_subtitle != subtitle_lines:
            ...
            if subtitle:
                ...
                subtitle = subtitle.replace('mr.', 'mr ').replace('mrs.', 'mrs ').replace('Mr.', 'mr ').replace(
                        'Mrs.', 'mrs '
                        ).replace('Sr.', 'Sr ').replace('sr.', 'sr ')

                for part in re.split(r'[?!.;:]', subtitle):
                    part = part.strip()

                    if part:
                        en_path, to_show_en_subtitle, to_show_ru_subtitle = process_subtitle(part)
...
def process_subtitle(subtitle):
    ...
    try:
        ...
        return en_path, to_show_en_subtitle, to_show_ru_subtitle

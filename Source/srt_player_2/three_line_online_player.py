...
def no_repit(text, test=False):
    ...
    for part in start:
        ...
        for word in words:
            ...
            if word not in f"{top_2000} {top_300} {past_subtitles}" and word:
                xxx(part, play_output)
                diff = 1
                break
